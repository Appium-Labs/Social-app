...
class SearchBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextField(
        controller: searchScreenController.usernameController,
        onChanged: (e) {
          if (e.isEmpty) {
            searchScreenController.showUsers.value = false;
          } else {
            searchScreenController.showUsers.value = true;
          }
          searchScreenController.getUsers();
        },
